...
check(manifest.rolloutClass === 'complex', 'rollout_class');
check(manifest.materialization === 'target_quality_gate_active_path', 'materialization');
...
check(router.rolloutClass === 'complex', 'router_rollout_class');
check(router.materialization === 'target_quality_gate_active_path', 'router_materialization');
...
check(router.targetProtections?.cryptoCustodyForbidden === true, 'crypto_custody');
check(router.targetProtections?.youtubePolicyComplianceClaimed === false, 'youtube_claim');
check(router.targetProtections?.deployForbidden === true, 'deploy_forbidden');
check(router.targetProtections?.walletAccessForbidden === true, 'wallet_forbidden');
check(router.targetProtections?.runtimeReadinessClaimed === false, 'runtime_claim');
check(router.targetProtections?.productionReadinessClaimed === false, 'production_claim');
