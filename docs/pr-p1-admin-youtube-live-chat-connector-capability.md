# P1 Admin YouTube Live Chat Connector Capability

## Current Scope

Adds a read-only admin endpoint that reports the current fake YouTube Live Chat connector capability.
...
Base SHA: 6d4624c94058f59d8465a1263657983e6a2a578e
...
- `corepack pnpm exec vitest run apps/api/src/p1-admin-youtube-live-chat-connector-capability.test.ts apps/api/src/p1-youtube-live-chat-fake-connector-loop.test.ts apps/api/src/p1-youtube-live-chat-client-contract.test.ts`
- `corepack pnpm lint`
