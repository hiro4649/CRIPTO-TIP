...
Head SHA: recorded in PR #13 body at merge review
...
Commit SHA: recorded in PR #13 body at merge review

Evidence freshness: GitHub checks passed for PR #13 before merge review.
