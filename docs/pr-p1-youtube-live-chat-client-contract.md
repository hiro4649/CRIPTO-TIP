...
Defines a client contract for future YouTube Live Chat connector work and implements a fake fixture client only.
...
Base SHA: 4a4948f8bcbfbf7ddaa550552c3655e2f2d62d59
...
- `corepack pnpm exec vitest run apps/api/src/p1-youtube-live-chat-client-contract.test.ts apps/api/src/p0-youtube-live-chat-page-fixture-parser.test.ts`
- `corepack pnpm lint`
